...
public class PublisherConstants {
	...
	public static final String CUSTOMER_NUMBER_ERROR_MSG = "Customer number must be less than 10 characters";
	...
	public static final String SUCCESS_MESSAGE = "Customer info published to kafka server";

	public static final String ERROR_MESSAGE = "Exception occurred while pushing message to kafka";
